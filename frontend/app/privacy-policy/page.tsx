...
export default function PrivacyPolicyPage() {
  ...
  async function loadContent() {
    try {
      setLoading(true);
      setError(null);
      const data = await cmsApi.getByPageKey('privacy_policy');
      setContent(data);
    } catch (err) {
        ...
        <Card className="w-full max-w-4xl">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-gray-600 mb-6">
              {error || 'Privacy policy content is not available at this time.'}
            </p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <div className="max-w-5xl mx-auto p-6 py-12">
        ...
        <Card className="shadow-2xl border-0">
          <CardHeader className="border-b bg-gradient-to-r from-purple-50 via-blue-50 to-indigo-50 p-8">
            ...
            {content.content ? (
              <div 
                className="
                  ...
                  prose-blockquote:text-gray-700 prose-blockquote:bg-blue-50 
