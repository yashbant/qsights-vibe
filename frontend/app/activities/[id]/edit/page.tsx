...
export default function EditActivityPage() {
  ...
  async function loadActivityData() {
    try {
      ...
      // Map activity data to form state
      setActivityData({
        title: activity.name || "",
        ...
        taxPercentage: activity.tax_percentage || "",
        numberOfParticipants: activity.number_of_participants || "",
        ...
        timeLimitEnabled: activity.time_limit_enabled || false,
      ...
      if (activity.registration_form_fields && activity.registration_form_fields.length > 0) {
        setRegistrationFields(normalizeRegistrationFields(activity.registration_form_fields));
      }
      ...
      // Mark activity as loaded to prevent re-fetching
                  ...
                  {activityData.allowGuests && (
                    <div className="ml-6 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                      <p className="text-xs text-blue-800">
                        ...
                        A public link will be generated for guest access
                      </p>
                    </div>
                  )}
                </div>
