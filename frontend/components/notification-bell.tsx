      ...
      if (notification.action_url) {
        ...
        switch (notification.type) {
          ...
          case 'approval_rejected':
            // For all approval notifications, go to the specific approval detail page
            if (notification.entity_id) {
              router.push(`/activities/approvals/${notification.entity_id}`);
            } else {
              // Fallback to activities list if no entity_id
              router.push(`/activities`);
            }
            break;
          case 'activity_assigned':
          case 'activity_completed':
            // For activity notifications, go to activities list
            router.push(`/activities`);
            break;
          case 'reminder':
          case 'event_update':
          ...
          default:
            ...
            if (notification.entity_type === 'activity' || notification.entity_type === 'event') {
              router.push(`/activities`);
            } else if (notification.entity_type === 'approval' && notification.entity_id) {
              router.push(`/activities/approvals/${notification.entity_id}`);
