...
const sidebarItems = [
  { icon: LayoutDashboard, label: "Dashboard", href: "/program-manager" },
  { icon: FolderTree, label: "Programs", href: "/programs" },
          ...
          <div className="h-full px-4 lg:px-6 flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="hidden md:flex items-center gap-2 text-sm">
                <span className="text-gray-500">Program Manager</span>
              ...
              <div className="relative">
                ...
                >
                  ...
                  <div className="hidden md:block text-left">
                    <p className="text-sm font-medium text-gray-900">{currentUser?.name || 'Program Manager'}</p>
                    <p className="text-xs text-gray-500">{currentUser?.role || 'Manager'}</p>
                  </div>
                    ...
                    <div className="bg-gradient-to-br from-qsights-blue to-blue-600 px-5 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-white font-semibold text-sm truncate">{currentUser?.name || 'Program Manager'}</p>
                          <p className="text-blue-100 text-xs lowercase truncate">{currentUser?.role?.replace('_', '-') || 'program-manager'}</p>
                        </div>
                      </div>
                      <div className="mt-3 pt-3 border-t border-white/20">
                        <p className="text-white/90 text-xs break-words">{currentUser?.email || 'manager@example.com'}</p>
                      </div>
                    </div>
